...
There are two ways to compute the variance components used in the GWAS analysis. Either the EMMA algorithm [@Kang2008] or the Newton Raphson algorithm [@Tunnicliffe1989]. Specify the method by setting the parameter `remlAlgo` to either `"EMMA"` or `"NR"`. By default the EMMA algorithm is used.
