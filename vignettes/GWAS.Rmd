...
```
Note that in the newly created object the phenotypic data is represented by a list containing 1 item named phenoRice. It is possible to add phenotypic data for i.e. several trials by adding a list of data.frames each containing the phenotypic data for a single trial.
